...
export function InvestorTotalProfits() {
  const theme = useTheme();
  const withdrawDialog = useBoolean();

  const { totalProfits } = useGetInvestorOverview();
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {t('investor.dashboard.dashboardOverview.totalProfits')}
        </Typography>
        ...
        >
          {t('investor.dashboard.dashboardOverview.withdraw')}{' '}
          <Iconify
      ...
      <Box
        ...
        alt={t('investor.dashboard.dashboardOverview.totalProfits')}
        sx={{
      ...
      <WithdrawDialog
        ...
        maxAmount={Number(totalProfits)}
        onSuccess={() => {
          // Refresh overview data after successful withdrawal
