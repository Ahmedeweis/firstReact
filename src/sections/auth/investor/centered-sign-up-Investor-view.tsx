...
export function CenteredSignUpInvestorView() {
  ...
  const SignUpInvestorSchema = zod
    .object({
  ...
  const methods = useForm({
    resolver: zodResolver(SignUpInvestorSchema),
    defaultValues,
  });
  ...
  return (
    <>
      ...
      <Stack alignItems="center" spacing={1.5} sx={{ mb: 5 }}>
        <Typography variant="h5">{t('auth.createAccountInvestor')}</Typography>
