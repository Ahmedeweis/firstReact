...
import { navClientData, navVendorData, navInvestorData } from '../config-nav-dashboard';
...
export function DashboardLayout({ sx, children, data }: DashboardLayoutProps) {
  ...
  const dashboardNavVendorData = user?.type === 'vendor' && navVendorData;
  const dashboardNavClientData = user?.type === 'client' && navClientData;
  const dashboardNavInvestorData = user?.type === 'investor' && navInvestorData;
  ...
  // log user 
  // console.log('user type in layout:', user?.type);
  return (
    <>
      <NavMobile
        data={dashboardNavVendorData || dashboardNavClientData || dashboardNavInvestorData || []}
      ...
      <LayoutSection
        ...
        headerSection={
          <HeaderBase
            ...
            data={{
              nav:
                dashboardNavVendorData || dashboardNavClientData || dashboardNavInvestorData || [],
              langs: allLangs,
              account: _account,
              contacts: _contacts,
            ...
            slots={{
              ...
              bottomArea: isNavHorizontal ? (
                <NavHorizontal
                  data={
                    dashboardNavVendorData ||
                    dashboardNavClientData ||
                    dashboardNavInvestorData ||
                    []
                  }
                  layoutQuery={layoutQuery}
                  cssVars={navColorVars.section}
